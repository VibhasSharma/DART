...
<div id="StageGate">    
    <img src="Dlhover.png" style="height:45px; width:150px; margin:15px 0px 0px 25px" onclick="myFunc3()"></img>
    <img src="MHhover-a.png" style="height:45px; width:160px; margin:15px 0px 0px 50px" onclick="goma()"></img>
    <img src="UNhover.png" style="height:45px; width:150px; margin:15px 0px 0px 50px" onclick="goUN()"></img>
    <img src="DAhover.png" style="height:45px; width:150px; margin:15px 0px 0px 50px" onclick="goHM()"></img>
    <img src="PGhover.png" style="height:45px; width:150px; margin:15px 0px 0px 50px" onclick="goPG()"></img>
</div>	
...
<div class="row" style="padding-bottom:0px; margin-top:0px; color:white">
    ...
    <div class="col-sm-2" style="padding-left:45px"><%out.println(count3);%>/ <%out.print(total);%></div>
    <div class="col-sm-2" style="padding-left:110px"><%out.println(count4);%>/ <%out.print(total);%></div>
          ...
          <form method="post"> 
            ...
            <div class="col-sm-4"> 
                 <div class="btn-sm">
                     ...
                     <button type="button" class="btn-sm dropdown-toggle" data-toggle="dropdown">Well Size
			<span class="caret"></span>
                    </button>
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                    ...
                    <button type="submit" class="btn-sm" name="promote" formaction="stage2.jsp">Promote</button>
                    <button type="submit" class="btn-sm" name="demote" formaction="Demote.jsp" style="background-color:#d8dad9; color:black; font-size:13px">Demote</button> 
                    ...
                    <button type="button" class="btn-sm" onclick="window.location = 'v2.jsp';" style="background-color:#d8dad9; color:black; font-size:13px">View All</button>					
        ...
        %>
            <tr class = "default" style="color:#e4e4e4">
               ...
               <td class="col-sm-2"><% out.println(name);%></td>
                ...
                <td class="col-sm-4"><% out.println(purposeWell);%></td>
            </tr> <%
}
    }
%>
