    ...
    <div class="col-sm-2" style="padding-right:110px"><%out.println(count4);%>/ <%out.print(total);%></div>
        ...
        <div class="col-sm-4"> 
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                    ...
                    <button id="promotebtn" type="submit" class="btn-sm" name="promote" formaction="stage3.jsp">Promote</button>
                    <button type="submit" class="btn-sm" name="demote" formaction="Demote1.jsp" style="background-color:#d8dad9; color:black; font-size:13px">Demote</button> 
                    ...
                    <button type="button" class="btn-sm" onclick="window.location = 'v3.jsp';" style="background-color:#d8dad9; color:black; font-size:13px">View All</button>					
