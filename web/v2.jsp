...
<div id="StageGate">    
    ...
    <button id="click" type="button" class="btn btn-info btn-arrow-right" onclick="goma()" style="background-color:#1d79fd">Mnemonic Harmonization</button>
    <button type="button" class="btn btn-info btn-arrow-right" onclick="goUN()">Unit Normalization</button>
    <button type="button" class="btn btn-info btn-arrow-right">Data Aggregation</button>
        ...
        <div class="row">
          <form method="post"> 
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                        ...
                        <button id="promotebtn" type="submit" class="btn-sm" name="promote" formaction="stage2.jsp">Promote</button>
                    ...
                    <button type="button" class="btn-sm" onclick="displayall()" style="background-color:#d8dad9; color:black; font-size:13px">View All</button>					
