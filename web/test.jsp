...
<div class="row" style="margin-bottom:0px">
            ...
            <div class="col-sm-4"> 
                 <div class="btn-sm">
                     ...
                     <button type="button" class="btn-sm dropdown-toggle" style="background-color:#d8dad9; color:black; font-size:13px" data-toggle="dropdown">Well Size
			<span class="caret"></span>
                    </button>
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                    ...
                    <button type="button" class="btn-sm" style="background-color:#d8dad9; color:black; font-size:13px">Demote</button>
                    ...
                    <button type="button" class="btn-sm" onclick="window.location = 'v1.jsp';" style="background-color:#d8dad9; color:black; font-size:13px">View All</button>					
