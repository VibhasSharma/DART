    ...
    <!--Double arrow left / right-->
        ...
        <div class="col-md-1">
          ...
          <ul style="list-style-type: none; margin:200px 0 0 45px">
            <li>
              <a style="list-style-type: none; color:white;"  formaction="mnemonicsupdate.jsp"><div class="fa fa-angle-double-right" style="font-size:30px"></div></a>
            </li>
        </div>  
        ...
        <div class="row">
            <div class="col-md-4" style="text-align:center">
                <div class="btn center-block"> 
                    <button class="btn btn-sm" style="background-color:#d8dad9; color:black; font-size:13px" formaction="fieldupdate.jsp">Next</button>&nbsp&nbsp&nbsp&nbsp&nbsp
