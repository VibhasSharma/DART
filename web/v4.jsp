...
<div id="StageGate">    
    ...
    <button type="button" class="btn btn-info btn-arrow-right" onclick="goHM()" style="background-color:#1d79fd">Data Aggregation</button>
    <button type="button" class="btn btn-info btn-arrow-right" onclick="goPG()">Pattern Generation</button>
</div>	
    
<div style="padding-bottom:0px; margin-top:0px; color:white">
    ...
    <div class="col-sm-2" style="padding-right:110px"><%out.println(count4);%>/ <%out.print(total);%></div>
        ...
        <div class="row">
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                    ...
                    <button id="promotebtn" type="submit" class="btn-sm" name="promote" formaction="stage4.jsp">Promote</button>
                    <button type="submit" class="btn-sm" name="demote" formaction="Demote2.jsp" style="background-color:#d8dad9; color:black; font-size:13px">Demote</button> 
