...
.scrollbar{ 
  ...
  #mlist{
    ...
    #mlist::-webkit-scrollbar { width:8px;background-color:#2c546d; } 
...
<!--Double right arrow-->
        ...
        <div class="col-md-1" style="margin-right:0px">
          <ul style="list-style-type: none; margin:200px 0 0 45px">
            <li>
              <a href="#" style="list-style-type: none; color:white;"  formaction="mnemonicsupdate.jsp"><div class="fa fa-angle-double-right" style="font-size:30px"></div></a>
            </li>
        </div>
            ...
            <div class="col-md-4">
                <div class="panel" style="background-color:#2c546d; opacity:0.9; width:410px">
                    ...
                    <div id="collapse5" class="panel-collapse collapse in">
                        <div class="panel-body" id="ex4" style="min-height:440px; background-color:#2c546d; opacity:0.7; overflow-y:scroll">
    ...
    <div class="row">
      <div class="col-md-4" style="text-align:center">
          ...
          <button type="submit" style="color:white; font-size:19px; background-color:transparent; outline:none; border:none" class="fa fa-refresh" formaction="refresh.jsp" style="font-size:20px"></button>
      </div>
      <div class="col-md-4" style="text-align:center">
          <button class="btn btn-sm" style="background-color:#d8dad9; color:black; font-size:13px" formaction="PatternGenerationUI.html">Generate Graph</button>
      </div>
